...
#fit()
# fitData = mMscaler.fit(data)
# print(fitData)
# MinMaxScaler()


# transform()
# List transform into numpy list
# transData = mMscaler.transform(data)
# print(transData)
...
# Do fit&transform at the same time  
transData = mMscaler.fit_transform(data)
# print(transData)
...
mScaled_data = pd.DataFrame(transData, columns=data.columns)
# print(mScaled_data)
#  Length  Diameter    Height  Whole weight  Shucked weight  Viscera weight  Shell weight     Rings
